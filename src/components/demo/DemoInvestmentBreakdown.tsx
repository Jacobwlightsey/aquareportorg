/* ──── Investment Breakdown (Page 2 of 2) ────
   Retail value, savings, discounts, financing options.
   The "numbers" page after the emotional pricing reveal.
   ──── */

import { Check, ChevronDown, ChevronUp, CreditCard, Tag } from "lucide-react";
    ...
    <div className="mx-auto w-full max-w-5xl px-8 pt-6">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-[15px] mt-2" style={{ color: colors.textMuted }}>
          Transparent pricing. Available savings. Financing options.
        </p>
      </div>
