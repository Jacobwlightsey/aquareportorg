...
// CRM lead/deal stages — unified across leads and deals tables
export type LeadStage = "new_lead" | "contacted" | "appointment_set" | "demo_completed" | "proposal_sent" | "negotiation" | "closed_won" | "closed_lost";
...
export const LEAD_STAGES: Array<{
  ...
  { key: "new_lead", label: "New Lead", color: "bg-slate-500", badge: "bg-slate-100 text-slate-700 dark:bg-slate-900 dark:text-slate-300" },
  { key: "contacted", label: "Contacted", color: "bg-blue-500", badge: "bg-blue-100 text-blue-700 dark:bg-blue-950 dark:text-blue-300" },
  { key: "appointment_set", label: "Appointment Set", color: "bg-cyan-500", badge: "bg-cyan-100 text-cyan-700 dark:bg-cyan-950 dark:text-cyan-300" },
  { key: "demo_completed", label: "Demo Completed", color: "bg-amber-500", badge: "bg-amber-100 text-amber-700 dark:bg-amber-950 dark:text-amber-300" },
  { key: "proposal_sent", label: "Proposal Sent", color: "bg-orange-500", badge: "bg-orange-100 text-orange-700 dark:bg-orange-950 dark:text-orange-300" },
  { key: "negotiation", label: "Negotiation", color: "bg-purple-500", badge: "bg-purple-100 text-purple-700 dark:bg-purple-950 dark:text-purple-300" },
  { key: "closed_won", label: "Closed Won", color: "bg-emerald-500", badge: "bg-emerald-100 text-emerald-700 dark:bg-emerald-950 dark:text-emerald-300" },
  { key: "closed_lost", label: "Closed Lost", color: "bg-red-500", badge: "bg-red-100 text-red-700 dark:bg-red-950 dark:text-red-300" },
];
