...
export function CreateCustomerPage() {
  ...
  // Auto-lookup utility by ZIP
  const handleZipLookup = useCallback(async () => {
    if (lead.zip.length < 5) return;
    setLoading(true);
    setError("");
    setUtilities([]);
      ...
      {step === 1 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter the homeowner's info. Their water report will be auto-generated by ZIP code.
            </CardDescription>
          </CardHeader>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    onBlur={() => {
                      if (lead.zip.length === 5 && !selectedUtility) handleZipLookup();
                    }}
                  />
                </div>
              </div>
